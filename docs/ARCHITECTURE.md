...
Native profile-selection UX, profile locking, runtime history wiring, bookmarks/session stores, broader settings wiring and migrations beyond schema v1 remain separate Z3 slices.
