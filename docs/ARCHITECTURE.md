...
Native profile-selection UX, profile locking, committed-navigation history recording, save timing/batching policy, bookmarks/session stores, broader settings wiring and migrations beyond schema v1 remain separate Z3 slices.
