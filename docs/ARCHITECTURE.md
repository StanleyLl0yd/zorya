...
Native profile creation/rename UX, profile deletion, private-browsing history policy, bookmarks/session stores, broader settings wiring and migrations beyond schema v1 remain separate Z3 slices.
