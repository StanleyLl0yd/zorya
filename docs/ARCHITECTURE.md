...
Native profile-selection UX, profile locking, default native save timings, navigation-to-history recording and save scheduling, private-browsing history policy, bookmarks/session stores, broader settings wiring and migrations beyond schema v1 remain separate Z3 slices.
