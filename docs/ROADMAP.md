...
- stable-ID multi-tab create/close/reorder product model plus two-phase TabActivationId selection lifecycle and an identity/generation-bound neutral presentation handoff guard; native neutral-cover/compositor handoff wiring and active-tab close safety remain tracked in issue #20 before multi-tab chrome is wired;
